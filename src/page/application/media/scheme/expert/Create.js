...
class Create extends Component {
	...
	onSubmit = (e) => {
		...
		this.props.form.validateFields((err, values) => {
			if (!err) {
				...
				formData.append('desc', values.desc == undefined ? '' : values.desc);
				formData.append('virtual_fan_count', values.virtual_fan_count || 0);
				formData.append('virtual_highest_red', values.virtual_highest_red || 0);
	...
	postData(data) {
		...
		NetMedia.createSchemeExpert(data).then((res) => {
