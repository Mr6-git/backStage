...
class Create extends Component {
	...
	postData(data) {
		...
		NetMedia.createArticle(data).then((res) => {
	...
	render() {
		...
		const { form, categoryData, tagsData, authorData, onClose } = this.props;
		const { getFieldDecorator } = form;

		const { previewVisible, previewImage, fileList, isLoading, showUrlFlag } = this.state;
		const uploadButton = (
			<div>
				<Icon type="plus" />
