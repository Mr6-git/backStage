			...
			return <Fragment>
						...
						<div className={styles.score}>
							<div className={styles.score_left}>
								{data.length > 0 ? <AnimateNumber value={oddsInfo_one.odds == 1 ? `${oddsInfo_one.odds}.01` : oddsInfo_one.odds} className={styles.animate_num} /> : ''}
							</div>
							<div className={styles.score_center}>VS</div>	
							<div className={styles.score_right}>
								{data.length > 0 ? <AnimateNumber value={oddsInfo_two.odds == 1 ? `${oddsInfo_two.odds}.01` : oddsInfo_two.odds} className={styles.animate_num} /> : ''}
							</div>
						</div>
